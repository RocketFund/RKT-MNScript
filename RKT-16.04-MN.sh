#!/bin/bash
# Rocketfundcoin Masternode Setup Script V1.0.0 for Ubuntu 16.04 LTS
#
...
wget https://github.com/RocketFund/RKT-MNScript/releases/download/v1.0.0/rocketfundcoin-16.04-ubuntu-daemon.tar.gz
tar -xzvf rocketfundcoin-16.04-ubuntu-daemon.tar.gz
